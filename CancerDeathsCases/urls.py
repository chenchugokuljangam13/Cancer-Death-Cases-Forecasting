...
from CancerDeathsCases import views as mainView
...
urlpatterns = [
    ...
    path("UserRegressions/", usr.UserRegressions, name="UserRegressions"),
    path("ForecastAnalysis/", usr.ForecastAnalysis, name="ForecastAnalysis"),
